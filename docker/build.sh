...
function prepareScript()
{
    ...
    addCommandLineOptionalArgument 'BUILD_ENV' '--build-env' bool 'Also build the environment image (chocotechnologies/dmboot-env)' 'FALSE'
...
#
prepareScript "$@"
if isStringEqual "$BUILD_ENV" "TRUE"; then
    buildEnv
fi
build 
